...
mod tests {
    use super::{
        ...
        python_runtime_environment, read_backend_response_limited,
        recent_transcript_ids_from_value, request_backend_shutdown, resolve_session_token,
        shell_ipc, shell_ipc_env_pairs, shortcut_id_for_hotkey,
