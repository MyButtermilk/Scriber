pub(crate) fn hash_sensitive_identifier(value: &str) -> String {
    if value.is_empty() {
        return String::new();
    }
...
#[cfg(test)]
mod tests {
    use super::hash_sensitive_identifier;

    #[test]
    fn hash_sensitive_identifier_matches_shared_endpoint_contract() {
        ...
        assert_eq!(hash_sensitive_identifier(""), "");
    }
}
