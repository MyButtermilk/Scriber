...
export const settingsTranslations = {
  ...
  "Celeris Console": "Celeris-Konsole",
  ...
  "Install a local model, then choose Use locally.":
    "Installiere ein lokales Modell und wähle anschließend „Lokal verwenden“.",
  "Live cleanup now runs on this device.": "Die Live-Bereinigung läuft jetzt auf diesem Gerät.",
  "Live cleanup now uses the selected cloud model.":
    "Die Live-Bereinigung verwendet jetzt das ausgewählte Cloud-Modell.",
  "Download started": "Download gestartet",
  "The model will stay inactive until you choose Use locally.":
    "Das Modell bleibt inaktiv, bis du „Lokal verwenden“ auswählst.",
  "Download canceled": "Download abgebrochen",
  "Cancellation requested": "Abbruch angefordert",
  "Cancel failed": "Abbruch fehlgeschlagen",
  "Local cleanup selected": "Lokale Bereinigung ausgewählt",
  "New post-processed dictations will use {{model}} on this device.":
    "Neue nachbearbeitete Diktate verwenden {{model}} auf diesem Gerät.",
  "Local model removed": "Lokales Modell entfernt",
  ...
  "Processing engine": "Verarbeitungsart",
  "Cleanup runs only on this device. A failure returns the original transcript.":
    "Die Bereinigung läuft nur auf diesem Gerät. Bei einem Fehler wird das ursprüngliche Transkript verwendet.",
  ...
  "{{model}} download progress": "Downloadfortschritt für {{model}}",
  "Verifying model files...": "Modelldateien werden geprüft ...",
  "Downloading model files...": "Modelldateien werden heruntergeladen ...",
  "Canceling download...": "Download wird abgebrochen ...",
  "About {{minutes}} min remaining": "Noch etwa {{minutes}} Min.",
  "Use locally": "Lokal verwenden",
  "Try download again": "Download erneut versuchen",
