...
export const settingsTranslations = {
  ...
  "{{price}}€/h with model-dependent Error": "{{price}} €/h mit modellabhängiger Fehlerquote",
  "0,00€/h with model-dependent Error": "0,00 €/h mit modellabhängiger Fehlerquote",
  ...
  "Cloud async / batch": "Cloud – asynchron / Stapelverarbeitung",
  "Finalizes captured audio after upload or recording stop.": "Finalisiert das aufgenommene Audio nach dem Upload oder dem Ende der Aufnahme.",
  "Local": "Lokal",
  ...
  "Speech-to-text provider": "Speech-to-Text-Anbieter",
  "Choose the primary transcription provider.": "Wähle den primären Transkriptionsanbieter.",
  "Current provider": "Aktueller Anbieter",
  "Async mode returns the transcript after recording stops.": "Der asynchrone Modus liefert das Transkript nach dem Ende der Aufnahme.",
  "Realtime mode uses AssemblyAI Universal-3.5 Pro through Pipecat.": "Der Echtzeitmodus verwendet AssemblyAI Universal-3.5 Pro über Pipecat.",
  "Multilingual streaming shows finalized text only. Scriber does not request partial text or enrichment signals.": "Das mehrsprachige Streaming zeigt nur finalisierten Text. Scriber fordert weder Teiltexte noch Anreicherungssignale an.",
  "Multilingual batch returns one final transcript after recording stops. Scriber does not request enrichment signals.": "Die mehrsprachige Stapelverarbeitung liefert nach dem Aufnahmeende ein finales Transkript. Scriber fordert keine Anreicherungssignale an.",
  ...
  "Optional. Detect pauses for segmented live transcription and Soniox SmartTurn. When off, Silero is not loaded and the recording is transcribed as one continuous segment.": "Optional. Erkennt Pausen für segmentierte Live-Transkriptionen und Soniox SmartTurn. Wenn deaktiviert, wird Silero nicht geladen und die Aufnahme als ein zusammenhängender Abschnitt transkribiert.",
  ...
  "Keep speaker…": "Sprecher behalten …",
  "Duplicate saved speaker": "Doppelter gespeicherter Sprecher",
  "Merge duplicate…": "Duplikat zusammenführen …",
