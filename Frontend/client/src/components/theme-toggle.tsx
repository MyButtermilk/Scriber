...
export function ThemeToggle({ align = "compact" }: ThemeToggleProps) {
  ...
  return (
    <div className={cn("flex items-center", align === "edge" && "shrink-0")}>
      ...
      >
        <span className="sr-only">{isDark ? t("Dark mode is active") : t("Light mode is active")}</span>
        ...
        <span className="magic-theme-toggle__stars" aria-hidden="true">
          <svg className="magic-theme-toggle__star magic-theme-toggle__star--1" viewBox="0 0 24 24">
            <path d="M12 2L14.4 9.6H22.4L16 14.4L18.4 22L12 17.2L5.6 22L8 14.4L1.6 9.6H9.6L12 2Z" />
          </svg>
          <svg className="magic-theme-toggle__star magic-theme-toggle__star--2" viewBox="0 0 24 24">
            <path d="M12 2L14.4 9.6H22.4L16 14.4L18.4 22L12 17.2L5.6 22L8 14.4L1.6 9.6H9.6L12 2Z" />
          </svg>
          <svg className="magic-theme-toggle__star magic-theme-toggle__star--3" viewBox="0 0 24 24">
            <path d="M12 2L14.4 9.6H22.4L16 14.4L18.4 22L12 17.2L5.6 22L8 14.4L1.6 9.6H9.6L12 2Z" />
          </svg>
          <svg className="magic-theme-toggle__star magic-theme-toggle__star--4" viewBox="0 0 24 24">
            <path d="M12 2L14.4 9.6H22.4L16 14.4L18.4 22L12 17.2L5.6 22L8 14.4L1.6 9.6H9.6L12 2Z" />
          </svg>
          <svg className="magic-theme-toggle__star magic-theme-toggle__star--5" viewBox="0 0 24 24">
            <path d="M12 2L14.4 9.6H22.4L16 14.4L18.4 22L12 17.2L5.6 22L8 14.4L1.6 9.6H9.6L12 2Z" />
          </svg>
          <svg className="magic-theme-toggle__star magic-theme-toggle__star--6" viewBox="0 0 24 24">
            <path d="M12 2L14.4 9.6H22.4L16 14.4L18.4 22L12 17.2L5.6 22L8 14.4L1.6 9.6H9.6L12 2Z" />
          </svg>
        </span>
