...
ffprobe duration probing. `scripts\build_windows.ps1 -RunMediaPreparationSmoke`
...
The current 2026-06-03 standard NSIS build after SciPy removal produced
`Scriber_0.1.0_x64-setup.exe` at `188.14 MiB` with SHA256
`b13d57f5cb6252bcf0eaa54db81bd67ffe96cdc5f1bbb1718bf7e8f29817ad22`. The
standard backend resource folder is `523.01 MiB`; an installed-package smoke
with frontend/WebView, media-preparation, cleanup, and strict uninstall checks
measured the temporary installed app at `535.88 MiB`.
