...
on explicit env/system `ffprobe` or best-effort fallbacks. Do not use this mode
as the standard release default until YouTube/file/Azure-MAI media smokes prove
the reduced bundle still covers the required workflows.
