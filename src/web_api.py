...
def _build_file_upload_limits(provider: str | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "rawAudioIngestMaxBytes": audio_limits.ingest.max_bytes if audio_limits.ingest else None,
        "rawAudioIngestMaxLabel": audio_limits.ingest.label if audio_limits.ingest else None,
        "videoMaxBytes": video_limits.ingest.max_bytes if video_limits.ingest else None,
        "videoMaxLabel": video_limits.ingest.label if video_limits.ingest else None,
