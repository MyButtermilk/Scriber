...
- `SCRIBER_SUMMARY_GEMINI_THINKING_BUDGET_TOKENS` (default: 1024)
- `SCRIBER_SUMMARY_GEMINI_MAX_TOKENS_RETRIES` (default: 2)
- `SCRIBER_SUMMARY_GEMINI_RETRY_MAX_OUTPUT_TOKENS` (default: 16384)
