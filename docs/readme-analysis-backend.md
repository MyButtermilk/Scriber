...
- `SCRIBER_MIC_ALWAYS_ON` aktiviert einen App-Level-Idle-Prewarm-Stream mit bounded Rolling-Prebuffer (`SCRIBER_MIC_PREBUFFER_MS`, default `400`); per-session Pipecat-Streams werden beim Pipeline-Cleanup weiterhin bewusst geschlossen.
